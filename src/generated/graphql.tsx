...
export type GetLunchesPastQueryVariables = Exact<{
  limit: Scalars['Int'];
}>;


export type GetLunchesPastQuery = (
  { __typename?: 'Query' }
...
/**
 * __useGetLunchesPastQuery__
 *
 * To run a query within a React component, call `useGetLunchesPastQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLunchesPastQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLunchesPastQuery({
 *   variables: {
 *      limit: // value for 'limit'
 *   },
 * });
 */
export function useGetLunchesPastQuery(baseOptions: Apollo.QueryHookOptions<GetLunchesPastQuery, GetLunchesPastQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLunchesPastQuery, GetLunchesPastQueryVariables>(GetLunchesPastDocument, options);
      }
export function useGetLunchesPastLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLunchesPastQuery, GetLunchesPastQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLunchesPastQuery, GetLunchesPastQueryVariables>(GetLunchesPastDocument, options);
        }
